...
class HelpdeskTicket(models.Model):
    ...
    res_partner_crm_lead_ids = fields.Many2one('res.partner.child.crm.lead', related = 'partner_id.res_partner_child_crm_lead_ids', readonly = True, string = "Lead Contact") 
